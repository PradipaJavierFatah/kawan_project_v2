...
<head>
    ...
    <style>
        ...
        .card {
            ...
            /* Initially position the card below */
            animation: fadeUp 0.5s forwards;
            animation-delay: 0.3s;
            /* Delay the animation for a smooth appearance */
        }
                        ...
                        <div class="col">
                            <div class="card h-100">
                                <div class="card-img-wrapper"
                                    style="position: relative; padding-top: 133.33%; overflow: hidden;">
                                    <img src="{{ asset($mentor->picture) }}" class="card-img-top" alt="{{ $mentor->name }}"
                ...
                <div class="d-flex flex-wrap justify-content-center g-4">
                    ...
                    <div class="card text-center">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <button class="btn w-100 mt-auto" style="background-color: #ba4e8a;color:mintcream;"
                                onclick="redirect1(event)">Pesan Sekarang</button>
                        </div>
                    </div>
                    <!-- Paket Standar -->
                    <div class="card text-center">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <button class="btn w-100 mt-auto" style="background-color: #ba4e8a;color:mintcream;"
                                onclick="redirect2(event)">Pesan Sekarang</button>
                        </div>
                    </div>
                    <!-- Paket Premium -->
                    <div class="card text-center">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <button class="btn w-100 mt-auto" style="background-color: #ba4e8a;color:mintcream;"
                                onclick="redirect3(event)">Pesan Sekarang</button>
                        </div>
                    </div>
                    <!-- Paket Ultimate -->
                    <div class="card text-center">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <button class="btn w-100 mt-auto" style="background-color: #ba4e8a; color:mintcream;"
                                onclick="redirect4(event)">Pesan Sekarang</button>
                        </div>
                    </div>
                </div>
            </div>
