...
<body class="bg-pink-50 font-sans leading-normal tracking-normal">
    ...
    @section('content')
        ...
        <section class="bg-purple-300 p-8 m-0 flex items-center justify-center fade-in">
        ...
        <section class="p-8 flex flex-col justify-center items-center fade-in">
            ...
            <span class="font-bold text-green-500 text-8xl mt-4 justify-center items-center">ENTP</span>
        </section>
