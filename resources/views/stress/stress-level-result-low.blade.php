...
<body class="bg-white text-gray-800">
    ...
    @section('content')
        ...
        <!-- Result Block -->
        <section class="my-4 mx-4 p-4 text-center rounded-lg bg-green-500 text-white">
            <div class="ml-8">
                <h1 class="text-4xl">Tingkat Stres Rendah</h1>
                <!-- Indicator Bar -->
                <div class="indicator-bar mx-auto my-4 relative">
                    ...
                    <div class="absolute left-0 w-1/3 flex justify-center">
                ...
                <p class="mt-2 text-xl">Anda berada pada tingkat stres yang rendah. Tingkat stres yang rendah menunjukkan
                    bahwa
                    Anda menangani tantangan hidup secara efektif dan menjaga keseimbangan yang sehat. Keadaan ini
                    memungkinkan Anda
                    menghadapi masalah dengan pola pikir yang tenang dan jernih, sehingga meningkatkan kesejahteraan secara
                    keseluruhan. Terus pertahankan level ini!</p>
                <!-- Additional text -->
                ...
                <p class="mt-1 text-lg font-kanit">4. Luangkan waktu untuk melakukan hal-hal yang Anda nikmati dan
                    memberikan Anda
                    kebahagiaan.</p>
