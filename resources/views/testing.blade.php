...
<body class="font-poppins">
    ...
    <div id="header">
        ...
        <div class="container">
            <div class="w-screen">
                <div
                    style="background-image: url('{{ asset('asset/home/bg-test.png') }}'); background-size: cover; background-position: center; height: 300vh;">
                    ...
                    <div class="text-center pt-8 mb-8 mt-8">
